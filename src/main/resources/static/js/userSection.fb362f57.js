        ...
        e3ce: function (t, e, s) {
            ...
            var i = function () {
                    ...
                    return s("div", {
                        ...
                        staticClass: "UserSection-Outer"
                    }, [s("div", {
                        staticClass: "UserSection-User"
                    }, [t._v(" " + t._s(t.user.name) + " ")]), s("img", {
                        staticClass: "UserSection-Avatar",
                        attrs: {
                            src: t.loadAvatar(t.user.photo),
                            alt: "avatar"
                        }
                    })]), s("div", {
                        staticClass: "UserSection-Inner"
                    }, [s("router-link", {
                    ...
                    }, [s("div", [t._v(" Модерация ")]), s("div", {
                        staticClass: "UserSection-ModerationNum"
                    }, [t._v(" " + t._s(t.user.moderationCount) + " ")])]) : t._e(), s("router-link", {
                        staticClass: "Link UserSection-Item",
                        attrs: {
                            to: "/settings"
                        }
                ...
                c = {
                    ...
                    methods: Object(r["a"])({}, Object(o["mapActions"])(["logout"]), {
                        loadAvatar: n["d"]
                    })
                },
                l = c,
